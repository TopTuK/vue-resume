...
const messages = {
    ...
    ru: {
        ...
        resume: {
            ...
            career_summary_text: 'Триумф - это одно слово, которое характеризует мое стремление в своей работе. Это же слово могло бы описать мое прошлое. Каждая организация, стремящаяся двигаться вперед, должна была измениться и адаптироваться к развивающейся среде. Разве вы не хотели бы, чтобы в вашей команде был кто-то, у кого есть опыт на всех этапах изменений? От инициирования, планирования, выполнения, мониторинга и закрытия проекта до навыков, необходимых для адаптации коммуникации к различным дисциплинам и навыкам, мне посчастливилось это сделать. Мне так понравилось это делать, что я даже искал и прошел сертификацию Mssters, чтобы еще больше расширить свой набор инструментов.',
