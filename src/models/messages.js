...
const messages = {
    en: {
        ...
        volunteer: {
            ...
            volunteer1: 'Since July 2021 I have been a member of the PMI Project Management Institute (https://pmi.org).',
            volunteer2: 'In November 2021, I joined the PMI Moscow сchapter volunteer team.',
            volunteer3: 'Passed school of presidents of local chapter of PMI. Nominated for the position of Vice President of Communications.',
            volunteer4: 'To preserve the community of project managers, to accumulate and increase experience, together with the volunteers of the Moscow branch of PMI, I created, develop and popularize the PMI Russia Club (participation in the Club is free - join, here you can calmly discuss pressing issues away from the big Internet)',
            volunteer5: 'In September 2022, I created a blog to promote the professions of Project Manager, Project Engineers, Systems Analysts, and other members of project and product teams.'
        },
        hobby: {
            section_title: 'My hobbies',
            hobby_title1: 'Approaches and methodology of project management. Software development: Scrum, Lean, project approach',
            roman_title: 'Leadership requires heart, gut, soul and scent. So:',
            roman_1: '- you have to lead with your heart;',
            roman_2: '- feel inwardly;',
            roman_3: '- invest soul in the team and the project',
            roman_4: '- to have a nose for all sorts of nonsense.',
            roman_summary: 'The commander-in-chief on the battlefield, as a metaphor for project management. By the beginning of the battle, the work of the commander-in-chief had already been completed.',
            roman_footer: 'Tom Demarco. A novel about project management',

            hobby_title2: 'Architecture and software development.',
            hobby_dev1: 'I have the skill and experience in software development using .Net (C#), Dart, Python, JavaScript.',
            hobby_dev2: 'I have practical experience in creating and training neural networks (NEAT, MNIST, CNN)',
            hobby_dev3: 'I understand architectural development patterns. I am familiar and not alien to such terms and abbreviations as IoC, Dependacy Injection, Closure, SOLID, Fabric Method, Service Locator, Singleton.',
            hobby_dev4: 'I understand the principles of microservice architecture. I have practical experience in CI/CD. I understand DevOps principles: Docker, K8S.',

            hobby_title3: 'I created and develop the musical group KAVёr. I play the bass guitar.',

            hobby_title4: 'I go in for active sports, in the summer at sea, in the winter in the mountains.',
        },
        talents: {
            title: 'Talents',
        ...
        jobs: {
            ...
            analyst_group_manager_description: 'JSC Kaspersky Lab is a leading international company operating in the field of information security and digital privacy since 1997. Kaspersky Lab technologies protect more than 400 million users and 220,000 corporate clients worldwide. I am a participant in projects for the release of the company\'s flagship products for B2C and B2B users.',
            analyst_group_manager_achievements: 'As a system analyst group manager, I take an active part in planning, executing and controlling the development of flagship Windows products such as Internet Security, Endpoint Security, Security Connection, Password Manager, Safe Kids and others. The analytics team consists of 10-14 highly qualified analysts who provide continuous product releases. The total number of the project team and stakeholders is more than 150 people.',
            analyst_group_manager_achievement1: 'I provide planning, implementation and control of the scope of work for product releases. Iterative development, 3 releases per year.',
            analyst_group_manager_achievement2: 'I am the leader of a team of analysts in a project to develop 10 different products for B2C and B2B. The team consists of 10-14 system analysts: control, development and motivation of employees.',
            analyst_group_manager_achievement3: 'Implemented employee motivation and development processes. I conduct extracurricular classes to teach new practices and methods of product development and hold regular 1-1 meetings.',
            analyst_group_manager_achievement4: 'Implemented a process for hiring and onoboarding new employees. The search time for new highly qualified employees was reduced to 1.5 months.',
            analyst_group_manager_achievement5: 'Standardized the requirements management process. Implemented a process for defining and validating the concept of requirements implementation, due to which the number of rejected requirements was reduced by an order of magnitude.',
            analyst_group_manager_achievement6: 'Developed and implemented an IT system for planning, controlling and automating the implementation of analytical activities for product releases. Handling some of the release activities has become a deterministic operational activity.',
            analyst_group_manager_tag1: 'Team management',
            analyst_group_manager_tag2: 'Employee development',
            analyst_group_manager_tag3: 'Leadership',
            analyst_group_manager_tag4: 'Stakeholders managment',
            analyst_group_manager_tag5: 'Project managment',

            analyst_team_lead: 'System Analyst Team Lead',
            analyst_team_lead_period: '05.2017 - 03.2022',
            analyst_team_lead_description: 'As a team leader of System Analysts, I worked on a project to release the company\'s flagship products for B2C and B2B users. Provided support for the release of product releases at all stages, from initiation to the release of a technical release and post-release activities.',
            analyst_team_lead_achievements: 'Worked as a team leader for systems analysts in projects for the release of products for the Windows OS. Carried out planning and control of the implementation of analytical activities for the release of products',
            analyst_team_lead_achievement1: 'Actively participated in the process of forming a scope of business requirements. The project ensures the release of more than 7 products for B2C and B2B. Ensured the identification of requirements at all levels: business requirements, user scenarios, system requirements.',
            analyst_team_lead_achievement2: 'Carried out setting tasks, monitoring the timing and quality of tasks. Managing customer expectations for implementation.',
            analyst_team_lead_achievement3: 'I provide decomposition of requirements into tasks into development and testing in Microsoft TFS.',
            analyst_team_lead_achievement4: 'I created and maintain a project knowledge base with a description of the release processes for product releases.',
            analyst_team_lead_achievement5: 'Implemented Python and .net library for interacting with Azure services. This made it easy to develop utilities for automating the analytical activities of the project.',
            analyst_team_lead_achievement6: 'Participated in the implementation of the Scaled Agile Framework to manage the project program.',
            analyst_team_lead_tag1: 'Requirements managment',
            analyst_team_lead_tag2: 'Project design',
            analyst_team_lead_tag3: 'Python',
            analyst_team_lead_tag4: '.net',
            analyst_team_lead_tag5: 'System architecture',

            senior_analyst: 'Senior System Analyst',
            senior_analyst_period: '10.2014 - 05.2017',
            senior_analyst_description: 'As a senior system analyst, I worked on a project to release flagship products for home users of the KIS line. The number of users is about 30 million. Provided content management for product releases according to received business level requirements.',
            senior_analyst_achievements: 'The main achievement for the period of work as a senior system analyst is the acquisition of expert knowledge about the operation of the product, the main limitations, and risks.',
            senior_analyst_achievement1: 'Managed the scope of work for product releases of the Kaspersky Internet Security product line. The total scope is about 150 business requirements.',
            senior_analyst_achievement2: 'The only analyst in the Kaspersky Fraud Prevention for Endpoints product development project. The main client is the largest bank in Ecuador. Involved in technical meetings with business customers, Pre-sale engineers, etc.',
            senior_analyst_achievement3: 'Received a patent for developing a feature to protect user input using IME technology.',
            senior_analyst_achievement4: 'Was a mentor for new analysts in the project.',
            senior_analyst_tag1: 'UML',
            senior_analyst_tag2: 'Use cases',
            senior_analyst_tag3: 'System requirements',
            
            system_analyst: 'System Analyst',
            system_analyst_period: '10.2011 - 10.2014',
            system_analyst_description: 'As a systems analyst, I participated in the identification, analysis, approval and support of system requirements in the technology group of content filtering and product analytics of Kaspersky Internet Security.',
            system_analyst_achievements: '',
            system_analyst_achievement1: 'Completely described the specification of the content filtering area.',
            system_analyst_achievement2: 'Conducted a research of the technological capabilities of browser plug-ins. As a result, together with the team, we developed plugins for Chrome, FireFox, Internet Explorer browsers.',
            system_analyst_achievement3: 'Ensured the harmonization of legal requirements for the product.',
            system_analyst_tag1: 'Function requirements',
            system_analyst_tag2: 'Nonfunction requirements',
            system_analyst_tag3: 'Requirements gathering',

            engineer: 'System engineer',
            russian_sapr: 'Russian SAPR',
            russian_sapr_period: '05.2010 - 06.2011',
            russian_sapr_description: 'Developed a workflow automation system for large state-owned enterprises. On the basis of PDM Lotsia provided the initiation, development and documentation of the project for RosAtom.',
            russian_sapr_achievements: '',
            russian_sapr_achievement1: 'Inspection of the enterprise, identification of the business process of workflow at all stages of design.',
            russian_sapr_achievement2: 'Writing technical specifications for development.',
            russian_sapr_achievement3: 'Implementation of automated workflow.',
            ...
            oviont_achievements: '',
            oviont_achievement1: 'Created the GUI design of the system.',
            oviont_achievement2: 'Developed a component for quick display of tabular data.',
            oviont_achievement3: 'Acquired the skill of developing the final product in Delphi (Pascal).',
            oviont_tag1: 'Delphi',
            oviont_tag2: 'Pascal',
        },
        skills: {
    ...
    ru: {
        ...
        volunteer: {
            ...
            volunteer1: 'С июля 2021 года являюсь членом Института проектного управления PMI (https://pmi.org).',
        ...
        hobby: {
            ...
            hobby_title1: 'Подходы и методология управления проектами. Разработка ПО: Scrum, Lean, проектный подход',
            roman_title: 'Для руководства нужны сердце, нутро, душа и нюх. Так что:',
            roman_1: '- руководить надо сердцем;',
            roman_2: '- чувствовать нутром;',
            roman_3: '- вкладывать в команду и проект душу;',
            roman_4: '- иметь нюх на всякую ерунду и бессмыслицу.',
            roman_summary: 'Главнокомандующий на поле битвы, как метафора управления проектами. К началу сражения работа главнокомандующего уже закончена.',
            roman_footer: 'Том Демарко. Роман об управлении проектами',

            hobby_title2: 'Архитектура и разработка программного обеспечения.',
            hobby_dev1: 'Обладаю навыком и опытом разработки ПО с использованием .Net (C#), Dart, Python, JavaScript.',
            hobby_dev2: 'Имею практический опыт в создании и обучении нейросетей (NEAT,  MNIST, CNN)',
            hobby_dev3: 'Понимание архитектурных паттернов разработки. Мне знакомы и не чужды такие термины и аббревиатуры, как IoC, Dependacy Injection, Closure, SOLID, Fabric Method, Service Locator, Singleton.',
            hobby_dev4: 'Понимаю принципы микросервисной архитектуры. Обладаю практическим  опытом в CI/CD. Понимаю принципы DevOps: Docker, K8S.',

            hobby_title3: 'Создал и развиваю музыкальную группу KAVёr. Играю на бас-гитаре.',

            hobby_title4: 'Занимаюсь активными видами спорта, летом на море, зимой в горах.',
        },
        talents: {
            title: 'Таланты',
        ...
        jobs: {
            ...
            system_analyst_achievement2: 'Провел исследование технологических возможностей плагинов для браузеров. В результате вместе с командой разработали плагины для браузеров Chrome, FireFox, Internet Explorer.',
