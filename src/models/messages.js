...
const messages = {
    en: {
        ...
        jobs: {
            ...
            analyst_group_manager_achievement1: 'Обеспечение планирования, реализации и контроля содержания работ для релизов продуктов. Итерационная разработка, 3 релиза в год.',
            analyst_group_manager_achievement2: 'Управление командой из 10-14 системных аналитиков: контроль, развитие и мотивация сотрудников.',
            ...
            analyst_group_manager_achievement6: 'Разработал и внедрил IT систему планирования, контроля и автоматизации выполнения аналитических активностей для релизов продукта. Обработка некоторых ежерелизных активностей стала детерменированной операционной деятельностью.',
            ...
            analyst_team_lead_achievement1: 'Активно участвую в процессе формирования скоупа бизнес-требований. Обеспечивал выявление требований на всех уровнях: бизнес-требования, пользовательские сценарии, системные требования.',
            analyst_team_lead_achievement2: 'Осуществляю постановку задач, контроль сроков и качества исполнения задач. Управление ожиданиями заказчиков по реализации.',
            analyst_team_lead_achievement3: 'Обеспечиваю декомпозицию требований на задачи в разработку и тестирование.',
            ...
            analyst_team_lead_achievement6: 'Участвую в процессе внедрения Scaled Agile Framework для управления программой проектов.',
    ...
    ru: {
        ...
        jobs: {
            ...
            analyst_group_manager_achievement2: 'Являюсь руководителем команды аналитиков в проекте по разработке 10 различных продуктов для B2C и B2B',
            analyst_group_manager_achievement3: 'Управление командой из 10-14 системных аналитиков: контроль, развитие и мотивация сотрудников.',
            analyst_group_manager_achievement4: 'Внедрил процессы мотивации и развития сотрудников. Провожу факультативные занятия по обучению новым практикам и методам разработки продуктов и провожу регулярные 1-1 встречи.',
            analyst_group_manager_achievement5: 'Внедрил процесс найма и обучения новых сотрудников. Время поиска новых высококвалифицированных сотрудников сократилось до 1.5 месяца.',
            analyst_group_manager_achievement6: 'Стандартизовал процесс управления требованиями. Внедрил процесс определения и подтверждения концепции реализации требований за счет которого количество отклоненных требований сократилось на порядок.',
            analyst_group_manager_achievement7: 'Разработал и внедрил IT систему планирования, контроля и автоматизации выполнения аналитических активностей для релизов продукта. Обработка некоторых ежерелизных активностей стала детерминированной операционной деятельностью.',
            analyst_group_manager_tag1: 'Управление командой',
            analyst_group_manager_tag2: 'Развитие сотрудников',
            analyst_group_manager_tag3: 'Лидерство',
            analyst_group_manager_tag4: 'Управление заинтересованными лицами',
            ...
            analyst_team_lead_description: 'В качестве руководителя команды Системных аналитиков работал в проекте по выпуску флагманских продуктов компании для B2C и B2B пользователей.  Обеспечивал поддержку выпуска релизов продуктов на всех этапах, начиная от инициации, заканчивая выпуском технического релиза и пострелизных активностей.',
            analyst_team_lead_achievements: 'Выполнял роль руководителя группы системных аналитиков в проектах по выпуску продуктов для ОС Windows. Осуществлял планирование и контроль выполнения аналитических активностей для выпуска продуктов.',
            analyst_team_lead_achievement1: 'Активно участвую в процессе формирования скоупа бизнес-требований. Проект обеспечивает выпуск более 7 продуктов для B2C и B2B. Обеспечивал выявление требований на всех уровнях: бизнес-требования, пользовательские сценарии, системные требования.',
            analyst_team_lead_achievement2: 'Осуществляю постановку задач, контроль сроков и качества исполнения задач. Управление ожиданиями заказчиков по реализации.',
            analyst_team_lead_achievement3: 'Обеспечиваю декомпозицию требований на задачи в разработку и тестирование.',
            analyst_team_lead_achievement4: 'Создал и поддерживаю проектную базу знаний с описанием процессов выпуска релиза продуктов.',
            analyst_team_lead_achievement5: 'Реализовал Python и .net библиотеку для взаимодействия с Azure сервисами. Это позволило легко разрабатывать утилиты для автоматизации аналитических активностей проекта.',
            ...
            senior_analyst_achievement2: 'Ялвлялся единственным аналитиком в проекте по разработке продукта Kaspersky Fraud Prevention for Endpoints. Основной клиент - самый крупный банк Эквадора. Привлекался к техническим встречам с заказчиками со стороны бизнеса, Per-sale инженерами и др.',
            ...
            oviont: 'Овионт',
            oviont_period: '06.2008 - 09.2009',
            oviont_description: 'Разрабатывал продукт для бюджетного предприятия Московсокой области',
            oviont_achievements: '',
            oviont_achievement1: 'Разработал компонент для быстрого отображения табличных данных',
            oviont_achievement2: 'Приобрел навык разработки конечного продукта на языке Delphi (Pascal)',
            oviont_tag1: 'Delphi',
            oviont_tag2: 'Pascal',
        },
        skills: {
